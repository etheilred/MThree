...
public interface IExprVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitP0Expr([NotNull] ExprParser.P0ExprContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitPurenExpr([NotNull] ExprParser.PurenExprContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitNegExpr([NotNull] ExprParser.NegExprContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitNumExpr([NotNull] ExprParser.NumExprContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="ExprParser.funcArgs"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFuncArgs([NotNull] ExprParser.FuncArgsContext context);
}
