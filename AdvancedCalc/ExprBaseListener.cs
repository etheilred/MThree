...
public partial class ExprBaseListener : IExprListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterP0Expr([NotNull] ExprParser.P0ExprContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterPurenExpr([NotNull] ExprParser.PurenExprContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitPurenExpr([NotNull] ExprParser.PurenExprContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterNegExpr([NotNull] ExprParser.NegExprContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitNegExpr([NotNull] ExprParser.NegExprContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterNumExpr([NotNull] ExprParser.NumExprContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitNumExpr([NotNull] ExprParser.NumExprContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="ExprParser.funcArgs"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterFuncArgs([NotNull] ExprParser.FuncArgsContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="ExprParser.funcArgs"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitFuncArgs([NotNull] ExprParser.FuncArgsContext context) { }
